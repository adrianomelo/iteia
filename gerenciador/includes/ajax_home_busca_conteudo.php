...
<div id="resultado">
      ...
      <table width="100%" border="1" cellspacing="0" cellpadding="0" id="table-conteudo">
        ...
        <tbody>
          ...
          ?>
          <tr>
            <td class="col-titulo"><a href="<?=$value['url'];?>" title="Clique para visualizar" target="_blank" class="ext"><?=$value['titulo'];?></td>
            <td class="col-autor"><?=$value['autores'];?></td>
            <td class="col-formato"><?=$value['formato'];?></td>
            <td class="col-situacao"><?=$value['situacao'];?></td>
            <td class="col-adicionar"><a href="javascript:adicionarConteudoHome(<?=$value['cod'];?>);">Adicionar</a></td>
          </tr>
          <?php
            endif;
          endforeach;
