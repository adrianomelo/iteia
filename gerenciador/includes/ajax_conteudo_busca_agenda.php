...
<div id="resultado">
      <div class="view">Exibindo
        <select id="exibir" onchange="javascript:mostrarTotal('#mostra_resultados_relacionamento', '<?=$resultado['link'];?>', 'pag_agenda');">
      ...
      <table width="100%" border="1" cellspacing="0" cellpadding="0">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td class="col-local"><?=$value['agenda_local'];?></td>
            <td class="col-data"><?=$value['agenda_periodo'];?></td>
            <td class="col-editar"><a href="agenda_edicao.php?cod=<?=$value['cod'];?>" title="Editar">Editar</a></td>
          </tr>
          <?php
            endif;
          endforeach;
        ...
        <tfoot>
          <tr>
            <td colspan="5" class="selecionados"><strong>Selecionados:</strong> <a href="javascript:submeteAcoesConteudo(1, '#mostra_resultados_relacionamento', '<?=$resultado['link'];?>&pagina=<?=$paginacao['pagina'];?>');">Apagar</a></td>
          </tr>
        </tfoot>
      </table>
      <div class="nav">P&aacute;ginas: <?=$paginacao['anterior'];?> <?=$paginacao['page_string'];?> <?=$paginacao['proxima'];?> </div>
