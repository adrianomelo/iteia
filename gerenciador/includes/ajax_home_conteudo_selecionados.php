...
$lista_noticias = $homebuscabo->getListaConteudoHomeSelecionados($paginahome, $destaque);
?>
        ...
        <p>Ordem de exibi&ccedil;&atilde;o na home:<br />
          <label>
          <input type="radio" name="ordem" id="ordem1" value="1"<?=($novaordem == 1)?" checked=\"checked\"":""?> onclick="ordenarItens()" />
...
?>
            <tr>
              ...
              <td class="col-tempo"><select name="select" onchange="homeMudaTempoConteudo('<?=$noticia["cod_item"]?>', this)">
